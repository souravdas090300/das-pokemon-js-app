...
/* let pokemonRepository = (function () {
  ...
  function showModal(pokemon) {
    let modalBody = $(".modal-body");
    let mdalTitle = $(".modal-title");
    let modalHeader = $(".modal-header");
    modalTitle.empty();
    modalBodyempty();

    let nameElement = $("<h1>" + item.name + "</h1>");
    let imageElementFront = $('<img class="modal-img" style="width:">');
    imageElementFront.attr("src", item.imageUrlFront);
    let imageElementBack = $('<img class="modal-img" style="width:">');
    ...
    modalTitle.append(nameElement);
    modalBody.append(imageElemntFront);
    modalBody.append(imageElementBody);
    modalBody.append(heigthElement);
